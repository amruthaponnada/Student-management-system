...
import java.awt.event.*;
 ...
 public class Update_Student extends Add_Student implements ActionListener{
    ...
    Update_Student(String idaa){
        ...
        t5=new JTextField();
        t5.setBounds(230,200,150,30);
        id15.add(t5);

        id6= new JLabel("Course:");
        ...
        id7= new JLabel("Branch:");
        id7.setBounds(50,250,100,30);
        id7.setFont(new Font("serif",Font.BOLD,20));
        id15.add(id7);

        t7=new JTextField();
        t7.setBounds(230,250,150,30);
        id15.add(t7);
        ...
        id10= new JLabel("Register Number:");
        id10.setBounds(50,300,170,30);
        id10.setFont(new Font("serif",Font.BOLD,20));
        id15.add(id10);
        f.setVisible(false);
        t9=new JTextField();
        t9.setBounds(230,300,150,30);
        id15.add(t9);
    ...
    void showData(String s){
        try{
            conn con = new conn();
            String str = "select * from student where reg_no = '"+s+"'";
            ...
            if(i==0)
                JOptionPane.showMessageDialog(null,"register number not found");
            new Search_Student();
        }catch(Exception ex){}
        f.setVisible(true);
        f.setSize(900,500);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b && i==1){
            try{
                conn con = new conn();
                String str = "update student set name='"+t1.getText()+"',fname='"+t2.getText()+"',age='"+age+"',dob='"+dat+"',address='"+t3.getText()+"',phone='"+t4.getText()+"',email='"+t5.getText()+"',course='"+t6.getText()+"',branch='"+t7.getText()+"',year='"+t8.getText()+"',reg_no='"+t9.getText()+"' where reg_no='"+r_no+"'";
