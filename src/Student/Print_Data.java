...
public class Print_Data implements ActionListener{
    ...
    String reg_no,name,father,address,phone,email,course,branch,age,dob,year;
    JButton b1,b2;
    ImageIcon icon;
    ...
    Print_Data(String r_no){
        ...
        id9.setLayout(null);
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("Student/pics/print.jpg"));
        id9.setIcon(img);
        ...
        id = new JLabel("Register Number:");
        id.setBounds(50,70,170,30);
